...
- (void)applyStyle
{
    ...
    [self setTitleColor:[self myHighlitedColor] forState:UIControlStateHighlighted];
...
- (void)setHighlighted:(BOOL)highlighted
{
    ...
    self.layer.borderColor = highlighted ? [self myHighlitedColor].CGColor : [self myBorderColor].CGColor;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (rightImage)
    {
        ...
        rightAccessoryRect.origin.x = CGRectGetWidth(self.bounds) - CGRectGetWidth(rightAccessoryRect) - self.imagePadding;
