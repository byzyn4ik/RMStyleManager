...
- (CGRect)textRectForBounds:(CGRect)bounds {
    ...
    CGRect inset = CGRectMake(bounds.origin.x + [self widthForLeftView], bounds.origin.y, bounds.size.width - [self widthForRightView]-[self widthForLeftView], bounds.size.height);
    return inset;
}
